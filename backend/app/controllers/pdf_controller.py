"""
PDF Controller for handling PDF-related HTTP requests.
"""
...
from ..schemas.pdf import PDFResponse, PDFListResponse, PDFDetailResponse
from ..schemas.pdf_chunk import PDFChunkResponse, PDFChunkListResponse, PDFChunkSearchResponse
...
def search_pdf_content(
    ...
    """Search PDF content with pagination."""
    try:
        pdf_service = PDFService(db)
...
def get_pdf_stats(
    ...
    try:
        pdf_service = PDFService(db)
        stats = pdf_service.get_pdf_stats(pdf_id)
